...
// Add this method to your CustomSubtitleContainer class
private setupAutoSubtitleListener(): void {
  window.addEventListener('autoSubtitleExtracted', (event: CustomEvent) => {
    ...
    if (isAutoGenerated) {
      // Add to auto-generated subtitles array
      this.autoGeneratedSubtitles.push(cue)
      
      // Keep only recent subtitles to prevent memory issues
...
// Add this method to access auto-generated subtitles
