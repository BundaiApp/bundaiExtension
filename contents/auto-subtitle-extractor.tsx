...
if (typeof chrome !== "undefined" && chrome.runtime) {
  chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    if (message.action === "setUseAutoGeneratedSubtitles") {
      console.log("[YouTube Manipulator] Received broadcast:", message.useAutoGenerated)
      
      if (youtubeManipulator) {
        youtubeManipulator.setEnabled(message.useAutoGenerated)
      } else {
        console.log("[YouTube Manipulator] Instance not ready, will use state on next init")
      }
