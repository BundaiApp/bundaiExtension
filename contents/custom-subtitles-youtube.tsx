...
class YouTubeSubtitleContainer {
  ...
  private async fetchAutoGeneratedSubtitles(): Promise<void> {
    ...
    if (!videoId) {
      console.log(
        "[YouTube Subtitles] No video ID found for auto-generated fetch"
      )
      return
    }
    ...
    try {
      console.log(
        "[YouTube Subtitles] Fetching auto-generated subtitles...",
        videoId
      )
      ...
      if (response && response.vtt) {
        ...
        this.lastProcessedSubtitle1Text = ""
        console.log(
          "[YouTube Subtitles] Loaded " +
            parsedSubtitles.length +
            " auto-generated cues"
        )
      } else {
        console.error(
          "[YouTube Subtitles] Auto-generated fetch failed:",
          response?.error
        )
      }
    } catch (error) {
      console.error(
        "[YouTube Subtitles] Error fetching auto-generated subtitles:",
        error
      )
    }
  }
